...
import { progressRecipe, type ProgressRecipeVariantProps } from '~/styled-system/recipes'
...
export const Progress = forwardRef<HTMLDivElement, ProgressProps>((props, ref) => {
  const [variantProps, progressProps] = progressRecipe.splitVariantProps(props)
