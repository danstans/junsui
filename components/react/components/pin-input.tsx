...
import { pinInputRecipe, type PinInputRecipeVariantProps } from '~/styled-system/recipes'
...
export const PinInput = forwardRef<HTMLDivElement, PinInputProps>((props, ref) => {
  const [variantProps, pinInputProps] = pinInputRecipe.splitVariantProps(props)
