...
import { ratingGroupRecipe, type RatingGroupRecipeVariantProps } from '~/styled-system/recipes'
...
export const RatingGroup = forwardRef<HTMLDivElement, RatingGroupProps>((props, ref) => {
  const [variantProps, ratingGroupProps] = ratingGroupRecipe.splitVariantProps(props)
